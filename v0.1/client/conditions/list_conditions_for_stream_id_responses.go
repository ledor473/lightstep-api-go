...
func (o *ListConditionsForStreamIDOK) Error() string {
	return fmt.Sprintf("[GET /{organization}/projects/{project}/searches/{stream-id}/conditions][%d] listConditionsForStreamIdOK ", 200)
}
...
func (o *ListConditionsForStreamIDUnauthorized) Error() string {
	return fmt.Sprintf("[GET /{organization}/projects/{project}/searches/{stream-id}/conditions][%d] listConditionsForStreamIdUnauthorized ", 401)
}
...
func (o *ListConditionsForStreamIDNotFound) Error() string {
	return fmt.Sprintf("[GET /{organization}/projects/{project}/searches/{stream-id}/conditions][%d] listConditionsForStreamIdNotFound ", 404)
}
...
func (o *ListConditionsForStreamIDInternalServerError) Error() string {
	return fmt.Sprintf("[GET /{organization}/projects/{project}/searches/{stream-id}/conditions][%d] listConditionsForStreamIdInternalServerError ", 500)
}
