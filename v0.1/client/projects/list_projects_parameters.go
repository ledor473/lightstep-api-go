...
// WithOrganization adds the organization to the list projects params
func (o *ListProjectsParams) WithOrganization(organization string) *ListProjectsParams {
	o.SetOrganization(organization)
	return o
}

// SetOrganization adds the organization to the list projects params
func (o *ListProjectsParams) SetOrganization(organization string) {
