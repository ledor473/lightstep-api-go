...
func (o *ListStreamsIDOK) Error() string {
	return fmt.Sprintf("[GET /{organization}/projects/{project}/searches][%d] listStreamsIdOK ", 200)
}
...
func (o *ListStreamsIDUnauthorized) Error() string {
	return fmt.Sprintf("[GET /{organization}/projects/{project}/searches][%d] listStreamsIdUnauthorized ", 401)
}
...
func (o *ListStreamsIDNotFound) Error() string {
	return fmt.Sprintf("[GET /{organization}/projects/{project}/searches][%d] listStreamsIdNotFound ", 404)
}
