...
func (o *TimeseriesOK) Error() string {
	return fmt.Sprintf("[GET /{organization}/projects/{project}/searches/{stream-id}/timeseries][%d] timeseriesOK  %+v", 200, o.Payload)
}
...
func (o *TimeseriesBadRequest) Error() string {
	return fmt.Sprintf("[GET /{organization}/projects/{project}/searches/{stream-id}/timeseries][%d] timeseriesBadRequest  %+v", 400, o.Payload)
}
...
func (o *TimeseriesUnauthorized) Error() string {
	return fmt.Sprintf("[GET /{organization}/projects/{project}/searches/{stream-id}/timeseries][%d] timeseriesUnauthorized  %+v", 401, o.Payload)
}
...
func (o *TimeseriesNotFound) Error() string {
	return fmt.Sprintf("[GET /{organization}/projects/{project}/searches/{stream-id}/timeseries][%d] timeseriesNotFound  %+v", 404, o.Payload)
}
...
func (o *TimeseriesInternalServerError) Error() string {
	return fmt.Sprintf("[GET /{organization}/projects/{project}/searches/{stream-id}/timeseries][%d] timeseriesInternalServerError  %+v", 500, o.Payload)
}
