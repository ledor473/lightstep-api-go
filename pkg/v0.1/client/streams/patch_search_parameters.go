...
// WithData adds the data to the patch search params
func (o *PatchSearchParams) WithData(data *models.CreateOrUpdateBody) *PatchSearchParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the patch search params
func (o *PatchSearchParams) SetData(data *models.CreateOrUpdateBody) {
	o.Data = data
}

// WithOrganization adds the organization to the patch search params
func (o *PatchSearchParams) WithOrganization(organization string) *PatchSearchParams {
	o.SetOrganization(organization)
	return o
}

// SetOrganization adds the organization to the patch search params
func (o *PatchSearchParams) SetOrganization(organization string) {
...
// WithStreamID adds the streamID to the patch search params
func (o *PatchSearchParams) WithStreamID(streamID string) *PatchSearchParams {
	o.SetStreamID(streamID)
	return o
}

// SetStreamID adds the streamId to the patch search params
func (o *PatchSearchParams) SetStreamID(streamID string) {
	o.StreamID = streamID
}
