...
func (o *ListStreamsOK) Error() string {
	return fmt.Sprintf("[GET /{organization}/projects/{project}/searches][%d] listStreamsOK  %+v", 200, o.Payload)
}
...
func (o *ListStreamsUnauthorized) Error() string {
	return fmt.Sprintf("[GET /{organization}/projects/{project}/searches][%d] listStreamsUnauthorized  %+v", 401, o.Payload)
}
...
func (o *ListStreamsNotFound) Error() string {
	return fmt.Sprintf("[GET /{organization}/projects/{project}/searches][%d] listStreamsNotFound  %+v", 404, o.Payload)
}
