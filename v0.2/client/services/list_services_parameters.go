...
// WithOrganization adds the organization to the list services params
func (o *ListServicesParams) WithOrganization(organization string) *ListServicesParams {
	o.SetOrganization(organization)
	return o
}

// SetOrganization adds the organization to the list services params
func (o *ListServicesParams) SetOrganization(organization string) {
	o.Organization = organization
}

// WithProject adds the project to the list services params
func (o *ListServicesParams) WithProject(project string) *ListServicesParams {
	o.SetProject(project)
	return o
}

// SetProject adds the project to the list services params
func (o *ListServicesParams) SetProject(project string) {
	o.Project = project
}
