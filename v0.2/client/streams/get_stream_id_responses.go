...
func (o *GetStreamIDOK) Error() string {
	return fmt.Sprintf("[GET /{organization}/projects/{project}/streams/{stream-id}][%d] getStreamIdOK ", 200)
}
...
func (o *GetStreamIDUnauthorized) Error() string {
	return fmt.Sprintf("[GET /{organization}/projects/{project}/streams/{stream-id}][%d] getStreamIdUnauthorized ", 401)
}
...
func (o *GetStreamIDNotFound) Error() string {
	return fmt.Sprintf("[GET /{organization}/projects/{project}/streams/{stream-id}][%d] getStreamIdNotFound ", 404)
}
...
func (o *GetStreamIDInternalServerError) Error() string {
	return fmt.Sprintf("[GET /{organization}/projects/{project}/streams/{stream-id}][%d] getStreamIdInternalServerError ", 500)
}
